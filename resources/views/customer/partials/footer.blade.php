    <div class="menubar-footer footer-fixed">
         <ul class="inner-bar">
            ...
            <li class="action-add-task">
               <a href="{{ route('customer.automaticOrder') }}">
                  <svg width="28" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <g clip-path="url(#clip0_1024_2974)">
                        <path class="PA" d="M20.1666 1.83337L13.7499 20.1667L10.0833 11.9167L1.83325 8.25004L20.1666 1.83337Z" fill="#203468" stroke="#203468" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                     </g>
                     <defs>
            ...
            <li>
               <a href="{{ route('customer.revenueRecord') }}">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="sidebar-content">
                  <div class="d-flex gap-10 align-items-center pb-20 line-bt">
                     <div class="avatar avt-40">
                        <img src="{{ asset('assets/images/avt/avt2.jpg') }}" alt="img">
                     </div>
                  ...
                  <ul class="pt-20 pb-20">
                     ...
                     <li class="mt-18 sub-menu" id="accordionExample">
                        ...
                        <ul 
                           ...
                           <li><a href="{{ route('customer.dashboard') }}" class="sub-menu-children">
               ...
               <div class="overflow-auto">
                  <div class="tf-container">
                     <ul>
                        ...
                        <li><a href="{{ route('customer.tasks') }}" class="nav-link-item pt-16 pb-16 line-bt not-link">
                           <span>My Task</span>
                           </a>
                        </li>
                        ...
                        <li><a href="empty-{{ route('customer.revenueRecord') }}" class="nav-link-item pt-16 pb-16 line-bt not-link">
