...
<div class="app-content style-5">
   <div class="tf-container">
      <div class="upper-main-btn mt-24 justify-content-between align-items-end">
         <div class="">
            <h3>USD {{ $userData->total_amount }}</h3>
      ...
      <div class="content">
         <div class="home-main-btn mt-10 align-items-center gap-16">
            ...
            <button class="btnd content d-block">
               <div class="body-4 text-white-2 fw-bold text-val-drop">{{ $userData->frozen_amount }}</div>
               <p class=" text-white-5 desc-val-drop">Frozen(USD)</p>
            </button>
            <button class="btnd content d-block">
               <div class="body-4 text-white-2 fw-bold text-val-drop">{{ number_format($userData->total_amount - $userData->frozen_amount, 2) }}</div>
