                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="flyout-right"> <a href="#">Authentication</a>
                                                                <ul>
                                                                    ...
                                                                    <li><a href="forget-country.html">Forget country</a></li>
                                                                    <li><a href="reset-country.html">Reset country</a></li>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" placeholder="Invitation Code*" name="invitation_code" value="" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            <label>Phone</label>
                                            <input class="form-control" type="text" placeholder="Mobile No." name="phone" value="" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            <label>Email</label>
                                            <input class="form-control" type="text" placeholder="Email Address" name="email" value="" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="mb-3">
