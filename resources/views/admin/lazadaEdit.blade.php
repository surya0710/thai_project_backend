                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="form theme-form" method="post" action="{{  route('lazada.update',['product_id' => $product->id]) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="text-end"><button type="submit" name="product_create" class="btn btn-success me-3">Save Changes</button>
                                        <a class="btn btn-danger" href="{{ route('lazada.list') }}">Cancel</a>
                                    </div>
                                    </div>
                                </div>
                            </form>
